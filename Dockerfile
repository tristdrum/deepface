...
# update image os
RUN apt-get update
RUN apt-get install -y ffmpeg libsm6 libxext6 libhdf5-dev
...
RUN pip install --trusted-host pypi.org --trusted-host pypi.python.org --trusted-host=files.pythonhosted.org -r /app/requirements_local
...
# RUN pip install --trusted-host pypi.org --trusted-host pypi.pythonhosted.org --trusted-host=files.pythonhosted.org lightgbm==2.3.1
